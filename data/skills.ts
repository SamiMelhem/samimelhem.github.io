// Helper function to calculate years of experience from start year
export function getExperienceString(startYear: number): string {
  const currentYear = new Date().getFullYear()
  const years = currentYear - startYear + 1 // +1 because if you started in 2026, you have 1 year in 2026
  return `${years}+ years`
}
...
export interface Skill {
  ...
  description: string
  startYear: number // Year started learning this skill (experience is calculated automatically)
  experience: string // Computed years of experience string
...
// Raw skill data with startYear - experience is computed when exported
const skillsData: Omit<Skill, 'experience'>[] = [
...
// Compute experience string from startYear for all skills
export const skills: Skill[] = skillsData.map(skill => ({
  ...skill,
  experience: getExperienceString(skill.startYear)
}))
