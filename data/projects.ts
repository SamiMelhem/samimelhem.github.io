...
const projects: Project[] = [
  {
    ...
    image: '/images/save-gas.png',
    techs: ['React', 'TypeScript', 'Convex', 'Vercel', 'Node.js', 'Auth0', 'Axios', 'Vite', 'Tailwind CSS', 'PostCSS'],
  ...
  },
  {
    ...
    image: '/images/exped-browser.png',
    techs: ['React', 'TypeScript', 'Node.js', 'Electron', 'Vite', 'Tailwind CSS', 'PostCSS', 'Radix UI', 'Lucide React'],
  ...
  },
  {
    ...
    image: '/images/panda-pos.png',
    techs: ['TypeScript', 'React', 'Next.js', 'Tailwind CSS', 'Lucide React', 'Node.js', 'Express.js', 'PostgreSQL'],
  ...
  },
  {
    ...
    image: '/images/financial-tool.png',
